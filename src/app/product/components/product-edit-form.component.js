...
<form method="post" id="edit-product" autocomplete="off">
...
export default class ProductEditForm extends HTMLElement {
    ...
    render() {
        ...
        this.elems.form.name.value = this.product.name;
        this.elems.form.price.value = this.product.price;
        this.elems.form.elements['image-url'].value = this.product.imageUrl;

        this.updateImagePreview(this.product.imageUrl);
    }
